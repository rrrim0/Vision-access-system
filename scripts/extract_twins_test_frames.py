...
VIDEO_DIR = Path("data") / "twins_videos_test"
OUT_DIR = Path("data") / "id_test_images" / "twins"
...
def process_video(person_name: str, video_path: Path, detector: FaceDetector):
    ...
    print(f"\n[{person_name}] Обработка тестового видео: {video_path}")
...
def main():
    ...
    print(f"\nИтог: всего сохранено {total} тестовых изображений.")
